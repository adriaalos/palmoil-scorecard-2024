<template>
    <div class="section u-section">
        <div class="u-container">
            <div class="px-6 py-20 u-gradient u-gradient--horiz u-gradient--ocre-ocrelight rounded-[20px]">
                <h2 class="font-wwf text-white u-fs48 text-center">SCORING CRITERIA</h2>
            </div>
            <div class="mt-20">
                <div class="chain">
                    <header class="chain__header">
                        <h2 class="u-fs48">OWN SUPPLY CHAIN</h2>
                    </header>
                    <div class="chain__block">
                        <header class="chain__block__header">
                           <h3 class="u-fs36">
                                COMMITMENTS
                                <span>4 <span>POINTS</span></span>
                           </h3>
                        </header>
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__points">
                                    <ul>
                                        <li>
                                            <strong>0.5 points</strong> if the commitment is deforestation-free but does not meet the Accountability Framework definition for conversion*-free
                                        </li>
                                        <li>
                                            <strong>1 point</strong> if the company has a no deforestation and no conversion commitment that meets the Accountability Framework definitions
                                        </li>
                                        <li>
                                            [<strong>1 point</strong> total for commitment]
                                        </li>
                                    </ul>
                                </div>
                                <div class="chain__block__points">
                            ...
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__turr">
                                    ...
                                    <div class="chain__block__description">
                                        ...
                                        <ul>
                                            <li>Be publicly available, such as on a company’s website</li>
                                            <li>Specify that the commitment covers no conversion or severe degradation of all natural ecosystems</li>
                                            <li>Apply across the entire company/corporate group</li>
                                            <li>Apply to all palm oil types sourced, including crude & refined palm oil (CPO), palm kernel oil (PKO), palm oil derivatives (POD), and palm kernel expeller (PKE)</li>
                                        </ul>
                                        <p>
                        ...
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__points">
                                    <ul>
                                        <li>
                                            <strong>0.5 points</strong> if human rights commitment does not cover the rights of all relevant stakeholder* groups or only partially meets the Accountability Framework’s definitions and requirements
                                            <br><br>
                            ...
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__turr">
                                    ...
                                    <div class="chain__block__description">
                                        ...
                                        <ul>
                                            <li>Be publicly available, such as on a company’s website</li>
                                            <li>Clearly outline the company’s commitment to uphold internationally recognised human rights, such as those outlined in the International Labour Organization (ILO) Conventions, UN Guiding Principles on Business and Human Rights and the UN Declaration on the Rights of Indigenous Peoples</li>
                                            <li>Apply to all people, regardless of gender and without discrimination</li>
                                            <li>Cover the following stakeholder groups: workers, indigenous people, local communities, and others who may be impacted by company activities</li>
                                            <li>Apply across the entire company/corporate group and all palm oil types sourced</li>
                                        </ul>
                                        <p>
                    ...
                    <div class="chain__block">
                        <header class="chain__block__header">
                           <h3 class="u-fs36">
                                ...
                                <span>11 <span>POINTS</span></span>
                           </h3>
                        </header>
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                <p class="chain__block__point">10 <span>POINTS</span></p>
                                <div class="chain__block__label">
                                    <p>
                                ...
                                <div class="chain__block__points chain__block__points--nospacer">
                                    <div class="chain__block__sublabel">
                                        <p><strong>Steps for companies:</strong></p>
                                    </div>
                                    <div class="chain__block__high">
                                        <div class="chain__block__high__num">1</div>
                                        <div class="chain__block__high__content">
                                            <div class="chain__block__points chain__block__points--nospacer">
                                                <p>
                                                    <strong>For companies with HQs Australia, Europe or North America:</strong>
                                                </p>
                                                <p>
                                                ...
                                                <ul>
                                                    <li>
                                                        CPO / PKO Uptake Scores:<br>
                                                        <strong>3 points</strong> x SG/IP/IS percentage of CPO/PKO volumes + <br>
                                                        <strong>1.5 points</strong> x MB percentage of CPO/PKO volumes 
                                                    </li>
                                                    <li>
                                                        POD Uptake Score:<br>
                                                        <strong>3 points</strong> x SG/IP/IS percentage of POD volumes + <br>
                                                        <strong>1.75 points</strong> x MB percentage of POD volumes + 1.25 points x B&C percentage of POD
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="chain__block__points">
                                                <p>
                                                    <strong>For companies with HQs in in emerging markets:</strong>
                                                </p>
                                                <p>
                                                ...
                                                <ul>
                                                    <li>
                                                        <strong>3 points</strong> x percentage of CPO/PKO/POD volumes RSPO certified (any model) 
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="chain__block__high">
                                        <div class="chain__block__high__num">2</div>
                                        <div class="chain__block__high__content">
                                            <div class="chain__block__points chain__block__points--nospacer">
                                                <p>
                                                ...
                                                <ul>
                                                    <li>
                                                        <strong>CPO Volume Score</strong> = CPO Uptake Score x percentage of CPO usage (i.e. CPO Volume/Total Volume)
                                                    </li>
                                                    <li>
                                                        <strong>PKO Volume Score</strong> = PKO Uptake Score x percentage of PKO usage (i.e. PKO Volume/Total Volume) 
                                                    </li>
                                                    <li>
                                                        <strong>POD Volume Score</strong> = POD Uptake Score x percentage of POD usage (i.e. POD Volume/Total Volume)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="chain__block__high">
                                        <div class="chain__block__high__num">3</div>
                                        <div class="chain__block__high__content">
                                            <div class="chain__block__points chain__block__points--nospacer">
                                                <p>
                                                ...
                                                <ul>
                                                    <li>
                                                        <strong>Overall score</strong> = (CPO volume score + PKO volume score + POD volume score) x 3
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="chain__block__col">
                                <div class="chain__block__turr">
                                    <h4 class="chain__block__subheader">WHY HAVE WE SCORED UPTAKE OF SUSTAINABLE PALM OIL THIS WAY?</h4>
                                    <div class="chain__block__description">
                                        <p>
                                ...
                                <div class="chain__block__turr">
                                    <h4 class="chain__block__subheader">WHY HAVE WE SCORED UPTAKE OF SUSTAINABLE PALM OIL THIS WAY FOR COMPANIES IN EMERGING MARKETS?</h4>
                                    <div class="chain__block__description">
                                        <p>
                        ...
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__points">
                                    <ul>
                                        <li>
                                            <strong>1 point</strong> if the quantities reported covers all palm oil types purchased across the entire corporate group, including in all countries where the group operates OR quantities cover all palm oil types purchased across the entire company, if company is not part of a corporate group
                                        </li>
                                        <li>
                                            <strong>0.5 points</strong> if the reported quantities relate to all the countries in which the company operates but do not relate to all countries in which the group operates (note: this option only applies if the company is part of a group)*
                                        </li>
                                        <li>
                                            <strong>0 points</strong> if the quantities do not cover all palm oil types AND/OR quantities do not cover the entire corporate group, if company is part of a corporate group
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="chain__block__col">
                                <div class="chain__block__turr">
                                    <h4 class="chain__block__subheader">WHY ARE WE ASKING THIS AND WHAT ARE WE LOOKING FOR?</h4>
                                    <div class="chain__block__description">
                                        <p>
                                        ...
                                        <div class="chain__block__description__note">
                                            <p>
                                                <strong>Note:</strong> A corporate group is defined in the Accountability Framework as “the totality of legal entities to which the company is affiliated in a relationship in which either party controls the actions or performance of the other,” and includes subsidiaries, affiliates, joint ventures and majority holdings.
                                            </p>
                                            <p>
                    ...
                    <div class="chain__block">
                        ...
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__points">
                                    <ul>
                                        <li>
                                            <strong>0.5 point</strong> if your company expects its suppliers to have a no deforestation and no conversion commitment that meets the Accountability Framework definitions
                                        </li>
                                        <li>
                                            <strong>0.25 points</strong> if your company expects its suppliers to have a deforestation-free commitment, but does not specify that the commitment should meet the Accountability Framework definition for conversion*-free
                                        </li>
                                    </ul>
                                </div>
                                <div class="chain__block__points">
                            ...
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__turr">
                                    ...
                                    <div class="chain__block__description">
                                        ...
                                        <ul>
                                            <li>Deforestation/Conversion Free Commitment</li>
                                            <li>Be publicly available, such as on a company’s website</li>
                                            <li>Specify that the commitment covers the conversion or severe degradation of all natural ecosystems</li>
                                            <li>Apply across the entire company/corporate group</li>
                                            <li>Apply to all palm oil types sourced, including crude & refined palm oil (CPO), palm kerneBusiness and Human Rights and the UN Declaration on the Rights of Indigenous Peoples</li>
                                            <li>Apply to all people, regardless of gender and without discrimination</li>
                                            <li>Cover the following stakeholder groups: workers, indigenous people, local communities, and others who may be impacted by company activities</li>
                                            <li>Apply across the entire company/corporate group and all palm oil types sourced</li>
                                        </ul>
                        ...
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                ...
                                <div class="chain__block__points">
                                    <ul>
                                        <li><strong>0.5 point</strong> if the company has a monitoring system for Traceability to Mill (TTM) and achieves more than 50 % TTM.</li>
                                        <li><strong>0 points</strong> if % TTM is 0 %</li>
                                        <li><strong>0.25 points</strong> if % TTM is less than 50 %</li>
                                    </ul>
                                </div>
                                <div class="chain__block__points">
                                    <ul>
                ...
                <div class="chain">
                    <header class="chain__header">
                        <h2 class="u-fs48">BEYOND OWN SUPPLY CHAIN</h2>
                    </header>
                    <div class="chain__block">
                        <header class="chain__block__header">
                           <h3 class="u-fs36">
                                SUSTAINABLE PALM OIL PLATFORMS
                                <span>2 <span>POINTS</span></span>
                           </h3>
                        </header>
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                <p class="chain__block__point">2 <span>POINT</span></p>
                                <div class="chain__block__label">
                                    <p>
                                ...
                                <div class="chain__block__points">
                                    <ul>
                                        <li>
                                            <strong>0.5 point</strong> for being an RSPO member
                                        </li>
                                        <li>
                ...
                <div class="chain">
                    <div class="chain__block">
                        ...
                        <div class="chain__block__grid">
                            <div class="chain__block__col">
                                <p class="chain__block__point">4 <span>POINTS</span></p>
                                <div class="chain__block__label">
                                    <p>
                                ...
                                <div class="chain__block__points">
                                    <p><strong>2 points for any one of following projects:</strong></p>
                                    <ul>
                                        <li>Supporting smallholder producers</li>
                                        <li>Biodiversity conservation (forest protection and/or restoration, regen agri practices etc.)</li>
                            ...
                            <div class="chain__block__col">
                                <div class="chain__block__turr">
                                    ...
                                    <div class="chain__block__description">
                                        ...
                                        <p>
                                            <strong>Supporting smallholder producers</strong><br>
...
.chain {
    ...
    &__block {
        @apply border border-[#DADADA] rounded-[12px];
        &__header {
            @apply px-8 py-8;
            h3 {
                @apply flex items-baseline space-x-6 font-wwf;
                > span {
                    @apply block ml-4 text-[#7B7B7B] text-sm font-open font-bold;
                }
            }
        }
        &__grid {
            @apply flex flex-wrap border-t border-[#DADADA]:
        ...
        &__label p {
            @apply mb-0 text-base font-open font-bold;
        }
        &__sublabel p {
            @apply mt-3 text-lg font-open;
        }
        &__points {
            @apply border-t border-t-dashed border-[#DADADA] mt-6 pt-6;
            ul {
                li {
                    @apply mb-5 pl-5 text-black font-open font-normal text-base last:mb-0;
                    &:before {
                        @apply content-[''] absolute left-0 top-1.5 w-[10px] h-[10px] bg-[#C4C4C4] inline-block rounded-full;
                    }
                }
            }
            p {
                @apply text-base font-open;
            }
            &--nospacer {
                @apply border-0 pt-0 mt-0;
            }
        }
        &__turr {
        ...
        &__description {
            ...
            ul {
                @apply list-disc pl-6 text-lg mb-6 last:mb-0;
            }
            &__note {
                @apply border-t border-t-dashed border-[#DADADA] mt-6 pt-6;
            }
